...
void nullbox::print(size_t indent, double offx, double offy)
{
    for (size_t i = 0; i < indent; i++)
        printf("    ");

    printf("(%f,%f) null: size(%f,%f:%f)\n", offx, offy, sizex, sizey, centery);
}

void charbox::print(size_t indent, double offx, double offy)
{
    for (size_t i = 0; i < indent; i++)
        printf("    ");
    printf("(%f,%f) char: (%d,%d,%d) size(%f,%f:%f)\n",
        offx, offy, (get_type()>>24)&255, (get_type()>>16)&255, (get_type())&65535, sizex, sizey, centery);
}
