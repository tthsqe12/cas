...
void subsuperscriptbox::print(size_t indent, double offx, double offy)
{
    for (size_t i = 0; i < indent; i++)
        printf("    ");

    printf("(%f,%f) subsuperscript: size(%f,%f:%f) cursor(%d)\n",
        ...
        case movearg_Up:
        {
            ...
            else
            {
                ...
                if (r == moveret_OK)
                    return r;
                cursor = 1;
                super.cbox->move(b, movearg_First);
                return moveret_OK;
            }
