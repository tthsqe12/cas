...
class cmplx_fxn_Tanh : public cmplx_fxn {
public:
    ...
    ex eval_arb_imag(const xarb_t&y, er def)
    {
        ...
        arb_tan(ereal_data(wy.get()), y.data, p);
...
ex num_Tanh(er X, er def)
{
    ...
    case ETYPE_DOUBLE:
    {
        return emake_double(tanh(edouble_number(X)));
    }
