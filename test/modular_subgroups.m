...
ClearAll[Gammah, Gamma1, Gamma0];
Gammah[n_] := Gammah[n] = ModularSubgroups`FromMemberQ[Function[Mod[#, n] === IdentityMatrix[2]]];
...
Do[
    Assert[ModularSubgroups`Index[Gammah[n]] === n^3/2*Product[1 - 1/p^2, {p, First/@FactorInteger[n]}]];
, {n, 3, 5}];
